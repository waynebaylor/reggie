...
if(!dojo._hasResource["hhreg.list"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.list"] = true;
...
if(!dojo._hasResource["hhreg.xhrTableForm"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.xhrTableForm"] = true;
...
if(!dojo._hasResource["hhreg.xhrAddForm"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.xhrAddForm"] = true;
...
if(!dojo._hasResource["hhreg.xhrAddList"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.xhrAddList"] = true;
...
if(!dojo._hasResource["hhreg.dialog"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.dialog"] = true;
...
if(!dojo._hasResource["hhreg.calendar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.calendar"] = true;
...
if(!dojo._hasResource["hhreg.xhrLink"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.xhrLink"] = true;
...
if(!dojo._hasResource["hhreg.xhrEditForm"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["hhreg.xhrEditForm"] = true;
...
dojo.i18n._preloadLocalizations("dojo.nls.reggie_admin", ["ROOT","ar","ca","cs","da","de","de-de","el","en","en-gb","en-us","es","es-es","fi","fi-fi","fr","fr-fr","he","he-il","hu","it","it-it","ja","ja-jp","ko","ko-kr","nb","nl","nl-nl","pl","pt","pt-br","pt-pt","ru","sk","sl","sv","th","tr","xx","zh","zh-cn","zh-tw"]);
